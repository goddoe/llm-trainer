...
echo "  --schema-file tests/test_schema.json"
echo ""
...
echo "uv run python inference_vllm_structured.py \\"
echo "  --model-path ./outputs/quick_test/merged \\"
echo "  --input-file tests/test_texts.txt \\"
...
echo "--------------"
echo "# 간단한 테스트"
echo "uv run python tests/test_simple_vllm.py"
echo ""
echo "# 전체 테스트 스위트"
echo "uv run python tests/test_vllm_inference.py --model Qwen/Qwen2.5-3B-Instruct"
echo ""
